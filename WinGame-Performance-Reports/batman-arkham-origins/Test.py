...
if __name__ == "__main__":
    base_path = r"D:\GAME TESTING\WinGame-Performance-Reports\batman-arkham-origins"
    files = {
        "high Settings": os.path.join(base_path, "batman_test_high.csv"),
    }
    ...
    if results:
        ...
        with open(md_path, "w", encoding="utf-8") as f:
            f.write("Performance Report: Batman Arkham origins\n\n")
